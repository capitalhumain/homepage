...
import com.delta.cs.rms.fuseki.vo.ReplaceGraphItem;
import com.delta.cs.rms.fuseki.vo.ReplaceGraphVO;
                            ...
                            for (ReplaceGraphItem item : valueObject.sourceItems) {
                                ...
                                try {
                                    ...
                                    if (item.namedGraph != null) {
                                        ...
                                        named_graph_uri = "http://com.delta.drc/rms#" + item.sourceDataset;
                                    }
