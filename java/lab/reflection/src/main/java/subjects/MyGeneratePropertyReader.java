...
public class MyGeneratePropertyReader implements PropertyReader {
    private final PropertyReader generatedPropertyAccessor;

    private final JavaCompiler javaCompiler;
    private final MyClassLoader classLoader;
    private final DiagnosticCollector<JavaFileObject> diagnosticCollector;

    public MyGeneratePropertyReader() {
        ...
        classLoader = new MyClassLoader(MyGeneratePropertyReader.class.getClassLoader());
    ...
    public PropertyReader generate() {
        String getterName = "getName";
        String packageName = String.format("%s.generated.%s", MyGeneratePropertyReader.class.getPackage().getName(), Person.class.getPackage().getName());
        ...
        final String source = "package " + packageName + ";\n" +
                "import model.Person;\n" +
                "public class " + className + " implements " + PropertyReader.class.getName() + " {\n" +
        ...
        Class<PropertyReader> compiledClass;
        try {
            compiledClass = (Class<PropertyReader>) classLoader.loadClass(fullClassName);
